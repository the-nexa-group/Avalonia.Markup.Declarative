...
public abstract class Component<TViewModel> : Component
{
    ...
    protected Component(TViewModel viewModel): base(ViewInitializationStrategy.Lazy)
    {
...
public abstract class Component : ViewBase, IMvuComponent
{
    ...
    protected Component() : this(ViewInitializationStrategy.Immediate)
    {
    }
   
    protected Component(ViewInitializationStrategy viewInitializationStrategy) : base(viewInitializationStrategy)
    {
    }
    ...
    public void UpdateState(Action? updateStateAction = null, bool bubbleToParent = false)
    {
        ...
        if (bubbleToParent && Parent is Component parentComponent)
    ...
    private void PerformStateUpdate()
    {
        ...
        try
        {
            ...
            {
                if (dependentView is Component componentBase)
