...
public class AvaloniaPropertyExtensionsGenerator : IIncrementalGenerator
{
    ...
    public static string GetPropertySetterExtension(string controlTypeName, string genericParamsAll, FieldDeclarationSyntax field)
    {
        ...
        var extensionText =
            $"public static {controlTypeName} {extensionName}{genericParamsAll}(this {controlTypeName} control, {argsString}){classConstraint}\n" +
    ...
    public static string GetCommonPropertySetterExtension(string controlTypeName, PropertyDeclarationSyntax property, SemanticModel semanticModel)
    {
        ...
        var extensionText =
            $"public static {controlTypeName} {extensionName}(this {controlTypeName} control, {argsString})\n" +
